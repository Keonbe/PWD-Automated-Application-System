...
export default function NewsArticle() {
  ...
  const getImageUrl = (path) => {
    ...
    return `http://localhost/webdev_finals/PWD-Automated-Application-System/Post-React-Migration/xampp-php-mysql-files/${path}`;
  };
            ...
            <footer className="article-footer mt-5 pt-4 border-top">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-muted small">
                  Last updated:{" "}
                  {formatNewsDate(article.updatedAt || article.createdAt)}
                </div>
              </div>
            </footer>
          </article>
