...
export default function UserPage() {
  ...
  const [isSidebarActive, setSidebarActive] =
    useState(
      false
    ); /** @summary Mobile sidebar visibility state. @remarks Controls the collapsible sidebar on mobile devices using CSS classes. */
  const [activeNav, setActiveNav] =
    useState(
      0
    ); /** @summary Active navigation item index. @remarks Tracks which navigation item is currently active (Dashboard, Help, Logout). */
  const [userData, setUserData] =
    useState(
      null
    ); /** @summary User data state storing profile and application information. @remarks Holds the information of the logged-in user fetched from API or demo data fallback. */
  const [loading, setLoading] =
    useState(
      true
    ); /** @summary Loading state for API data fetch operations. @remarksShows loading spinner while user data is being retrieved from the API. */
  const [error, setError] =
    useState(
      null
    ); /** @summary Error state for API request failures. @remarks Holds any error messages related to user data fetching when API calls fail and triggers demo data fallback. */

  // help modal useState refer: https://react-bootstrap.netlify.app/docs/components/modal/
  const [showHelpModal, setShowHelpModal] =
    useState(
      false
    ); /**  @summary Help modal visibility state for user assistance. @remarks Controls the display of the help information modal using React Bootstrap. */
  // modal handlers
  const handleCloseHelpModal = () =>
    setShowHelpModal(
      false
    ); /** @summary Closes the help modal dialog.  @remarks Handler function for modal close events and cancel actions. */
  const handleShowHelpModal = () =>
    setShowHelpModal(
      true
    ); /** @summary Opens the help modal dialog. @remarks Triggered when user clicks the help navigation item or help button. */

  // File list state
  const [userFiles, setUserFiles] = useState(
    []
  ); /** @summary Uploaded files list for current user. */
  const [filesLoading, setFilesLoading] =
    useState(false); /** @summary Loading state for file fetch. */
  const [filesError, setFilesError] =
    useState(null); /** @summary Error message for file operations. */
    ...
    <div className="user-dashboard-wrapper">
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              <img
                ...
                className="user-header-logo align-self-center"
              />
      ...
      {error && (
        <div className="container px-4 mt-2">
          <div className="alert alert-warning">
            ...
            <strong>Note:</strong> Could not load live data ({error}). Showing
            demo data.
          </div>
        </div>
      )}
      ...
      <div
        className={`user-overlay ${
          isSidebarActive ? "user-overlay-active" : ""
        }`}
      ...
      <div className="user-app-container">
          ...
          {activeNav === 1 ? (
              ...
              <form onSubmit={handleEditProfileSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleEditProfileChange("contactNumber", e.target.value)
                    }
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleEditProfileChange("emergencyNumber", e.target.value)
                    }
            ...
            <div className="user-card pwd-card-preview">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="user-card-title mb-0">
                  PWD ID Application Card
                </h3>
                <button
              ...
              <p className="text-muted small mb-4">
                Preview your PWD application details. Click Print to save or
                print this card.
              </p>
              ...
              <div className="pwd-id-card">
                ...
                <div className="pwd-card-footer">
                  ...
                  <div className="pwd-card-row">
                    ...
                    <span
                      className={`pwd-value pwd-status-${(
                        userData.status || ""
                      ).toLowerCase()}`}>
                ...
                {/* QR Code */}
                <div
                  className="pwd-card-qr"
                  role="region"
                  aria-label="PWD ID Verification QR Code">
                  <span className="sr-only">
                    QR Code containing PWD ID information for verification
                  </span>
                  <QRCodeSVG
                  ...
                  <span className="pwd-qr-sublabel">
                    PWD ID: {userData.regNumber || "N/A"}
                  </span>
                </div>
              </div>
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    <div className="border rounded p-3">
                      ...
                      <p className="mb-1">
                        <strong>Tel:</strong> {userData.tel || "—"}
                      </p>
                      <p className="mb-0">
                  ...
                  <div className="col-md-6">
                    <div className="border rounded p-3">
                      ...
                      <p className="mb-1">
                        ...
                        {userData.proofIdentity || "Not uploaded"}
                      </p>
                      <p className="mb-0">
                        <strong>Medical Certificate:</strong>{" "}
                        {userData.proofDisability || "Not uploaded"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="user-card">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  ...
                  <p className="user-card-subtitle mb-0">
              ...
              {filesLoading ? (
                ...
                <div className="alert alert-info">
                  ...
                  No documents uploaded yet. Please upload your documents during
                  registration.
                </div>
              ) : (
              ...
              <div className="mt-4 p-3 bg-light rounded">
                <h6 className="mb-2">
                  <i className="fas fa-chart-pie me-2"></i>Upload Status
                </h6>
                <div className="row">
                  ...
                  <div className="col-sm-6 col-md-3">
                    ...
                    <p className="h5 mb-0 text-success">
                      {userFiles.filter((f) => f.status === "approved").length}
                    </p>
                  </div>
                  <div className="col-sm-6 col-md-3">
                    <small className="text-muted">Pending</small>
                    <p className="h5 mb-0 text-warning">
                      {userFiles.filter((f) => f.status === "pending").length}
                    </p>
                  </div>
                  <div className="col-sm-6 col-md-3">
                    <small className="text-muted">Rejected</small>
                    <p className="h5 mb-0 text-danger">
                      {userFiles.filter((f) => f.status === "rejected").length}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <p className="user-page-subtitle">
                Track your PWD ID application progress
              </p>
              ...
              <div className="user-card">
                <div className="d-flex justify-content-between align-items-start flex-wrap gap-3">
                  <div>
                    ...
                    <p className="mb-2">
                      <strong>Registration No:</strong> {userData.regNumber}
                    </p>
                    ...
                    {(() => {
                      ...
                      return (
                        <span
                          className={`user-status-badge ${info.badgeClass}`}>
                          {info.label === "Under Review" ? (
                ...
                <div className="user-progress-container">
                  <div className="user-progress-bar-wrapper">
                    {(() => {
                      ...
                      return (
                        <div
                          className={`user-progress-fill ${info.fillClass}`}
              ...
              <div className="user-card">
                ...
                {(() => {
                  ...
                  const statusUpdateDate = formatDate(
                    userData.updatedAt || userData.regDate
                  );
                  ...
                  const latestReviewDate =
                    userFiles.length > 0
                      ...
                      : null;
                  const documentsVerifiedDate = formatDate(
                    latestReviewDate || userData.regDate
                  );
                  ...
                  if (status === "pending") {
                    return (
                      <div className="user-activity-item">
                        ...
                        <p className="user-activity-desc">
                    ...
                    return (
                      <>
                        <div className="user-activity-item">
                          ...
                          <p className="user-activity-desc">
                            Congratulations! Your PWD application has been
                            approved.
                          </p>
                        </div>
                        <div className="user-activity-item">
                    ...
                    return (
                      <>
                        <div className="user-activity-item">
                          ...
                          <p className="user-activity-desc">
                            Your application status has been updated. Please
                ...
                <div className="user-activity-item">
                  ...
                  <p className="user-activity-desc">
                    Your PWD application has been successfully submitted.
                  </p>
                </div>
              </div>
            </>
        ...
        <Modal
          ...
          <Modal.Body>
            <p>
              Are you sure you want to change your password? Please make sure
              you enter your new password correctly.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button variant="secondary" onClick={handleCloseConfirmModal}>
        ...
        <Modal
          ...
          onHide={handleCloseEditConfirmModal}
          centered>
          <Modal.Header closeButton>
          ...
          <Modal.Body>
            <p>
              Are you sure you want to update your profile with the following
              changes?
            </p>
            <ul className="small">
              {editChanges.address && <li>Address updated</li>}
              {editChanges.contactNumber && <li>Contact number updated</li>}
              {editChanges.emergencyContact && (
                <li>Emergency contact name updated</li>
              )}
              {editChanges.emergencyNumber && (
                <li>Emergency contact number updated</li>
              )}
            </ul>
          </Modal.Body>
          <Modal.Footer>
            <Button variant="secondary" onClick={handleCloseEditConfirmModal}>
              Cancel
            </Button>
            <Button
              variant="primary"
        ...
        <Modal show={showHelpModal} onHide={handleCloseHelpModal} size="lg">
          ...
          <Modal.Body>
            <div className="help-content">
              ...
              <ul>
                <li>
                  <strong>Under Review:</strong> Your application is being
                  processed by our team
                </li>
                <li>
                  <strong>Accepted:</strong> Your PWD ID has been accepted and
                  will be issued
                </li>
                <li>
                  <strong>Denied:</strong> Your application was not accepted.
              ...
              <ul>
                <li>
                  <strong>Submitted:</strong> Application received
                </li>
                <li>
                  <strong>Verification:</strong> Documents are being verified
                </li>
                <li>
                  <strong>Review:</strong> Under final review
                </li>
                <li>
                  <strong>Approval:</strong> Final decision stage
                </li>
              </ul>
              ...
              <div className="alert alert-info mt-3">
                <i className="fas fa-info-circle me-2"></i>
                <strong>Note:</strong> Application processing typically takes
                7-14 business days.
              </div>
            </div>
          </Modal.Body>
